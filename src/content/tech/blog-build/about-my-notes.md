...
![Vercel 导入仓库](https://picr2.jiaxin404.top/posts/tech/blog-build/about-my-notes/vercel-import-repository.webp)
4. Deploy，在Vercel 会自动识别你的项目是什么框架（Astro, Next.js, etc.），并帮你填好所有构建设置。你什么都不用改，直接点击 Deploy 按钮
![Vercel 部署设置](https://picr2.jiaxin404.top/posts/tech/blog-build/about-my-notes/vercel-deploy-settings.webp)

5. 稍等片刻，Vercel网站就已经上线了！Vercel 会提供一个 .vercel.app 结尾的免费域名供你访问。
![Vercel 生产部署](https://picr2.jiaxin404.top/posts/tech/blog-build/about-my-notes/vercel-production-deployment.webp)
...
![Namesilo 域名搜索](https://picr2.jiaxin404.top/posts/tech/blog-build/about-my-notes/namesilo-domain-search.webp)
...
![Cloudflare DNS 记录](https://picr2.jiaxin404.top/posts/tech/blog-build/about-my-notes/cloudflare-dns-records.webp)
...
![Vercel 域名状态](https://picr2.jiaxin404.top/posts/tech/blog-build/about-my-notes/vercel-domain-status.webp)
